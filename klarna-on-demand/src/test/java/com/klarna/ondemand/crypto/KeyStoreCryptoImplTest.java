...
@Ignore("Currently Robolectric doesn't support AndroidKeyStore feature. I've opened an issue - https://github.com/robolectric/robolectric/issues/1518")
@RunWith(RobolectricTestRunner.class)
@Config(emulateSdk = 18)
@PrepareForTest(SharedPreferencesCryptoImpl.class)
@PowerMockIgnore({ "org.mockito.*", "org.robolectric.*", "android.*", "org.json.*" })
public class KeyStoreCryptoImplTest extends CryptoBaseTst {
    @Override
    ...
    public void sign_shouldCaclculateAValidSignature() throws NoSuchAlgorithmException, InvalidKeyException, SignatureException, InvalidKeySpecException {
        KeyStoreCryptoImpl spyCrypto = (KeyStoreCryptoImpl) Mockito.spy(crypto);
